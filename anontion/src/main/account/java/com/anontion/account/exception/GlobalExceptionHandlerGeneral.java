...
public class GlobalExceptionHandlerGeneral {
  ...
  public ResponseEntity<ResponseDTO> handleInvalidJson(HttpMessageNotReadableException ex) {
    ...
    ResponseDTO response = new ResponseGenericDTO(new ResponseHeaderDTO(false, 1, "Bad Request (HttpMessageNotReadable)"), new ResponseBodyErrorDTO("Format could not be read."));
